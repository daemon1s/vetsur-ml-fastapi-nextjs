...
La plataforma funciona con una infraestructura de microservicios, e incluye una [sección de arquitectura interactiva](https://vetsur.daemonize.me/arquitectura) para explicar el flujo de datos.
